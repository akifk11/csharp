...
namespace NetFramework.S19.D3.MessageBoxNesnesi
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Kullaniciya gostermek istedigimiz bilgi", "Baslik Bilgisi", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void btnSoruSor_Click(object sender, EventArgs e)
        {
            ...
            // messageBox bize dialogresult dönüyor
